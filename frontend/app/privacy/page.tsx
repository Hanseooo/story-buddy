        ...
        <div className="space-y-10 text-foreground/80 leading-relaxed">
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-3">
              ...
              <li><strong>AI Processing:</strong> To turn stories into picture books, the redacted text is processed securely by our AI partners (OpenRouter, fal.ai) to generate the pictures. All infrastructure is hosted securely in the Singapore region.</li>
            </ul>
          </section>
