            ...
            <div className="space-y-5">
              ...
              <div className="space-y-4 text-foreground/80 leading-relaxed text-lg">
                ...
                <ul className="list-disc pl-5 space-y-3 marker:text-primary">
                  ...
                  <li><strong>Dual Independent Classifiers:</strong> Chained safety gates run on both text (Qwen3Guard-Gen) and output images (Falconsai ViT + Gemma-3-27B rubric).</li>
