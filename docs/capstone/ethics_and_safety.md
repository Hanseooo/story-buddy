...
* **Scope of Redaction:** The redaction applies uniformly across the application. The child's story text routes through this exact same PII gate before storage, captioning, or export. 
