...
| [ADR-042](./adr/ADR-042-reliable-selectable-styles-gouache-default-comic-retired.md) | Reliable selectable styles: Gouache default, Comic retired, Cut-paper promoted | Accepted (2026-08-17) · amended 2026-08-22; resolves D-O; amends ADR-022 |
...
| [ADR-044](./adr/ADR-044-child-owned-quiescent-storybooks-are-hard-deleted-through-an-idempotent-cleanup-job.md) | Child-owned quiescent storybooks are hard-deleted through an idempotent cleanup job | Accepted (2026-08-24) · resolves D-J; amends ADR-006/021 |
| [ADR-045](./adr/ADR-045-person-pseudonymization-is-disabled-by-default-structured-identifiers-still-redact.md) | Person pseudonymization is disabled by default; structured identifiers still redact | Accepted (2026-09-01) · amends ADR-011; supersedes an ADR-041 rejected alternative |
| [ADR-046](./adr/ADR-046-clean-base-retry-is-ratified-and-adr-037-decision-3-is-superseded.md) | Clean-base retry is ratified; ADR-037 Decision 3 is superseded | Accepted (2026-09-01) · supersedes ADR-037 D3; ratifies visual-prompt-reliability §4.4 |
| [ADR-047](./adr/ADR-047-the-scene-constraint-judge-reads-the-original-scene-prompt-not-the-corrected-one.md) | The scene-constraint judge reads the original scene prompt, not the corrected one | Accepted (2026-09-01) · amends ADR-004 (judge input only) |
| [ADR-048](./adr/ADR-048-canonical-references-are-minted-only-for-characters-a-scene-contains.md) | Canonical references are minted only for characters a scene contains | Accepted (2026-09-01) · amends ADR-004 (reference selection only) |
| [ADR-049](./adr/ADR-049-the-scene-constraint-judge-returns-structured-contradictions-not-free-text-labels.md) | The scene-constraint judge returns structured contradictions, not free-text labels | Accepted (2026-09-02) · amends ADR-004; extends ADR-047; escape hatch corrected by ADR-050 |
| [ADR-050](./adr/ADR-050-the-reference-judge-gets-one-retry-and-an-unchecked-reference-is-counted-in-the-record.md) | The reference judge gets one retry, and an unchecked reference is counted in the record | Accepted (2026-09-02) · amends ADR-025/028 |
| [ADR-051](./adr/ADR-051-the-vlm-judge-provider-pool-is-pinned-so-the-adr-018-incumbent-baseline-is-measurable.md) | The VLM judge provider pool is pinned, so the ADR-018 incumbent baseline is measurable | Accepted (2026-09-02) · amends ADR-002 |
| [ADR-052](./adr/ADR-052-an-objects-description-is-permanent-appearance-per-scene-change-lives-on-the-scene.md) | An object's description is permanent appearance; per-scene change lives on the scene | Accepted (2026-09-02) · extends ADR-040; amends ADR-023 (additive `Scene` field) |
| [ADR-053](./adr/ADR-053-an-object-is-described-on-axes-not-in-prose.md) | An object is described on axes, not in prose | Accepted (2026-09-03) · supersedes ADR-052 D1, replaces D4 render shape; amends ADR-023 (`StoryObject` axes) |
| [ADR-054](./adr/ADR-054-a-shared-object-needs-a-named-holder-in-the-direction.md) | A shared object needs a named holder in the direction | Accepted (2026-09-03) · extends ADR-052 D3 and ADR-048 (`segment` prompt gains a recorded version) |
| [ADR-055](./adr/ADR-055-a-prompt-change-is-measured-by-rate-not-read-off-a-page.md) | A prompt change is measured by rate, not read off a page | Accepted (2026-09-03) · amends ADR-054 D1 and retires its Verification; extends ADR-048 (`SEGMENT_PROMPT_VERSION` 1 → 3) |
| [ADR-056](./adr/ADR-056-numeric-attribute-fidelity-is-a-documented-limitation-not-a-pre-campaign-fix.md) | Numeric attribute fidelity is a documented limitation, not a pre-campaign fix | Accepted (2026-09-03) · narrows ADR-028's stated remedy; clarifies ADR-018 scope; extends ADR-055 D5 and D3 to the reference judge |
| [ADR-057](./adr/ADR-057-hard-negative-coverage-is-best-effort-the-species-and-style-match-is-not.md) | Hard-negative coverage is best-effort; the species and style match is not | Accepted (2026-09-03) · removes an unpreregistered rule from `validate_hard_negative_matches`; requires a preregistration amendment |
| [ADR-058](./adr/ADR-058-narration-and-pdf-export-are-cut-from-the-evaluated-scope.md) | Narration and PDF export are cut from the evaluated scope | Accepted (2026-09-04) · supersedes ADR-020; retires the export half of ADR-013; narrows CC-6 and the Tool A "Picture book production" row |
| [ADR-059](./adr/ADR-059-story-titles-are-job-metadata-checked-synchronously-before-persistence.md) | Story titles are job metadata, checked synchronously before persistence, never entering `StoryMemory` | Accepted (2026-09-09) · resolves the gate opened by `docs/specs/story-titles.md` §2 |
