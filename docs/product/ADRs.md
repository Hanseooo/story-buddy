...
| [ADR-049](./adr/ADR-049-the-scene-constraint-judge-returns-structured-contradictions-not-free-text-labels.md) | The scene-constraint judge returns structured contradictions, not free-text labels | Accepted (2026-09-02) · amends ADR-004; extends ADR-047 |
